...
public:
  HAIRPROC_API
  static HairProcHairProceduralSceneIndexRefPtr New(const HdSceneIndexBaseRefPtr& inputSceneIndex);
...
protected:
  ...
  void _PrimsAdded(
    const HdSceneIndexBase& sender, const HdSceneIndexObserver::AddedPrimEntries& entries) override;
...
private:
  void _init_deformer(const SdfPath& primPath, HairProcHairProceduralSchema& procSchema,
  ...
  typedef std::unordered_map<SdfPath, HairProcHairProceduralDeformerSharedPtr, SdfPath::Hash>
    _HairProcMap;
