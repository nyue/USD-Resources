...
HdContainerDataSourceHandle HairProcHairProceduralSchema::BuildRetained(
  const HdVec2fArrayDataSourceHandle& paramuv, const HdPathArrayDataSourceHandle& target,
  const HdIntArrayDataSourceHandle& prim, const HdVec3fArrayDataSourceHandle& rest)
{
...
{
  return HairProcHairProceduralSchema(parent
...
{
  static const HdDataSourceLocator locator(HairProcHairProceduralSchemaTokens->hairProcedural);
  return locator;
}
...
const HdDataSourceLocator& HairProcHairProceduralSchema::GetPrimLocator()
{
  static const HdDataSourceLocator locator(
    HairProcHairProceduralSchemaTokens->hairProcedural, HairProcHairProceduralSchemaTokens->prim);
  return locator;
}
...
{
  static const HdDataSourceLocator locator(
    HairProcHairProceduralSchemaTokens->hairProcedural, HairProcHairProceduralSchemaTokens->target);
  return locator;
}
...
{
  static const HdDataSourceLocator locator(
    HairProcHairProceduralSchemaTokens->hairProcedural, HairProcHairProceduralSchemaTokens->rest);
  return locator;
}

HairProcHairProceduralSchema::Builder& HairProcHairProceduralSchema::Builder::SetParamuv(
...
HairProcHairProceduralSchema::Builder& HairProcHairProceduralSchema::Builder::SetTarget(
...
HairProcHairProceduralSchema::Builder& HairProcHairProceduralSchema::Builder::SetPrim(
...
HairProcHairProceduralSchema::Builder& HairProcHairProceduralSchema::Builder::SetRest(
...
{
  return HairProcHairProceduralSchema::BuildRetained(_paramuv, _target, _prim, _rest);
}
