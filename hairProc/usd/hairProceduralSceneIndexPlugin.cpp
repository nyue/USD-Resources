...
namespace {
    struct _HairProcWindowsRegistration {
        _HairProcWindowsRegistration() {
            try {
                PXR_NS::HdSceneIndexPluginRegistry::Define<
                    PXR_NS::HairProcHairProceduralSceneIndexPlugin>();
                PXR_NS::HdSceneIndexPluginRegistry::GetInstance()
                    .RegisterSceneIndexForRenderer(
                        PXR_NS::TfToken(),
                        PXR_NS::TfToken("HairProcHairProceduralSceneIndexPlugin"),
                        nullptr,
                        0,
